<!-- File: /app/Views/examinations/promotion/create.php -->
<div class="container-fluid px-0">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            <h4 class="mb-0">Create Promotion Rule</h4>
            <small class="text-muted">Define a new promotion rule</small>
        </div>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="<?= BASE_URL ?>/promotion/rules">
                <div class="row g-3">
                    <div class="col-md-12">
                        <label class="form-label">Rule Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="name" placeholder="e.g., Standard Promotion" required>
                    </div>
                    <div class="col-md-12">
                        <label class="form-label">Description</label>
                        <textarea class="form-control" name="description" rows="2" placeholder="Brief description of this promotion rule"></textarea>
                    </div>
                    <div class="col-md-4">
