            ...
            <div class="card-body p-2">
                <div class="row g-2 align-items-center">
                    ...
                    <div class="col-md-3 d-flex align-items-center">
                        ...
                        <input type="text" name="search" class="form-control form-select-sm" placeholder="Name, Adm, Reg..." value="<?= htmlspecialchars($search) ?>" onchange="this.form.submit();">
                    </div>
                    ...
                    <?php foreach ($students as $index => $st): ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?= BASE_URL . '/student/show?id=' . $st['id'] ?>" class="btn btn-xs btn-outline-info me-1 py-0 px-1" title="View Profile">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="<?= BASE_URL . '/student/edit?id=' . $st['id'] ?>" class="btn btn-xs btn-outline-warning py-0 px-1" title="Edit Student">
