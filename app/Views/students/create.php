    ...
    <form action="<?= BASE_URL ?>/students/store" method="POST" enctype="multipart/form-data" class="needs-validation">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-header bg-white py-3">
                <h6 class="mb-0 fw-bold text-primary">Personal Details</h6>
            </div>
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <label class="form-label">Registration No. (System Generated)</label>
                    ...
                    <div class="col-md-4">
                        <label class="form-label">Admission No. (System Generated)</label>
