...
<div class="container-fluid px-0">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="<?= BASE_URL ?>/academic/terms?year=<?= $term->academic_year_id ?>" class="btn btn-sm btn-outline-secondary">
    ...
    <div class="card p-4">
        <form method="POST" action="<?= BASE_URL ?>/academic/terms/<?= $term->id ?>">
            <div class="row g-3">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="name" id="name" class="form-control" value="<?= htmlspecialchars($term->name ?? '') ?>" required>
                </div>

                <div class="col-md-4">
                    <label for="term_number" class="form-label fw-bold">Term Sequence/Number</label>
                    <input type="number" name="term_number" id="term_number" class="form-control" value="<?= htmlspecialchars($term->term_number ?? 1) ?>" min="1" max="4">
                </div>

                <div class="col-md-4">
                    <label for="start_date" class="form-label fw-bold">Start Date <span class="text-danger">*</span></label>
                    <input type="date" name="start_date" id="start_date" class="form-control" value="<?= $term->start_date ?>" required>
                </div>

                <div class="col-md-4">
                    <label for="end_date" class="form-label fw-bold">End Date <span class="text-danger">*</span></label>
                    <input type="date" name="end_date" id="end_date" class="form-control" value="<?= $term->end_date ?>" required>
                </div>

                <div class="col-12">
                    <div class="form-check">
                        <input type="checkbox" name="is_current" id="is_current" class="form-check-input" value="1" <?= !empty($term->is_current) ? 'checked' : '' ?>>
                ...
                <div class="col-12 mt-4">
                    ...
                    <a href="<?= BASE_URL ?>/academic/terms?year=<?= $term->academic_year_id ?>" class="btn btn-secondary ms-2">Cancel</a>
                </div>
            </div>
        </form>
    </div>
