<!-- File: /app/Views/academic/departments/edit.php -->
<div class="container-fluid px-0">
    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
        <div>
            <h4 class="mb-0 fw-bold">Edit Department</h4>
            <small class="text-muted">Update the department's details</small>
        </div>
    ...
    <div class="card p-3 p-md-4">
        <form method="POST" action="<?= BASE_URL ?>/academic/departments/<?= (int)$department->id ?>">
            ...
            <div class="row g-3">
                ...
                <div class="col-12 d-flex flex-wrap gap-2 mt-3 pt-3 border-top">
                    ...
                    <button type="button"
                            ...
                            data-bs-target="#deleteDepartmentEditModal">
...
<div class="modal fade" id="deleteDepartmentEditModal" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-body pt-2">
                <p class="mb-1">
                    ...
                    <strong><?= htmlspecialchars($department->name ?? 'this department', ENT_QUOTES, 'UTF-8') ?></strong>?
                </p>
            ...
            <div class="modal-footer border-0 pt-0">
                ...
                <button type="button" class="btn btn-danger" id="confirmDeleteEditDepartmentBtn">
...
<script>
(function () {
    const confirmEl = document.getElementById('confirmDeleteEditDepartmentBtn');
    if (!confirmEl) return;
    ...
    confirmEl.addEventListener('click', function () {
        ...
        const url  = '<?= BASE_URL ?>/academic/departments/<?= (int)$department->id ?>/delete';
        ...
        .then(function (res) {
            if (res.json && res.json.success) {
                window.location.href = '<?= BASE_URL ?>/academic/departments';
                return;
            }
